...
function DSys(){
    ...
    //Style Variables(Required for custom CSS vars to be used in-line)
    const flowSpace = { "--flow-space": '4rem', flexBasis: '100%' } as React.CSSProperties;
    const flowSpace2 = { "--flow-space": '4rem', marginBottom: '50vh' } as React.CSSProperties;
      ...
      <section className="flow" id="interactive-elements">
        ...
        <div className="flex">
          <div style={{marginTop: '5rem'}}>
            {/* explore button */}
            <a href="#"
              className="large-button uppercase ff-serif fs-600 text-dark bg-white">Explore</a>
          </div>

          <div className="flow" style={flowSpace2}>
            {/* Tabs */}
